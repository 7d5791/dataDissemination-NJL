...
#ifndef volunteerDilemma_H
#define volunteerDilemma_H
 ...
 */
class volunteerDilemma : public BaseWaveApplLayer {
	public:
	...
	protected:
        ...
        double vodM(vector<long double> u);
