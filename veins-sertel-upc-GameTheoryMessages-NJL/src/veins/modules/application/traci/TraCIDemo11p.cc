...
double TraCIDemo11p::betaCalculation(int k, int n, double alfa)
{
...
double TraCIDemo11p::forwardingGame(int N,int M, vector<long double> beta){
       double** mat;
       mat = new double*[N];
       for(int i = 0; i < N; ++i)
           mat[i] = new double[M];
...
double TraCIDemo11p::getLinkQuality(WaveShortMessage* wsm){
...
double TraCIDemo11p::calBeq(double k, double u, double r, double n){

    return pow((k/((u*(1+r*(n-1))))),(1/(n-1)));
}


double TraCIDemo11p::calUtility(double ageFactor, double distanceFactor, double linkQualityFactor)
{
...
double TraCIDemo11p::calAgeFactor(double timeElapsed)
{
...
double TraCIDemo11p::calS(updatedWeightsMetrics vectorR, double r)
{
   double s=0;
   double max=0;
...
double TraCIDemo11p::calAverage(vectorMetrics metric, simtime_t tHello)
{
...
double TraCIDemo11p::distanceFactorCalc(double d_sr, double d_ri, double r_max, bool  r_vehicleOnIntersection)
{
...
void TraCIDemo11p::printPhLayer(WaveShortMessage* wsm) {
...
void TraCIDemo11p::printMacLayer(WaveShortMessage* wsm) {
...
double TraCIDemo11p::getChannelQuality() {
...
double TraCIDemo11p::getSignalQuality(WaveShortMessage* wsm) {
...
double TraCIDemo11p::getCollisionProbability() {
...
void TraCIDemo11p::printTracyLayer(WaveShortMessage* wsm) {
...
int TraCIDemo11p::forwardElim(double** mat, int N, int M){
...
vector<long double> TraCIDemo11p::backSub(double** mat, int N, int M){
...
vector<long double>  TraCIDemo11p::gaussianElimination(double** mat, int N, int M){
...
void  TraCIDemo11p::swap_row(double** mat, int N, int M, int i, int j){
...
void TraCIDemo11p::print(double** mat, int N, int M){
