...
#ifndef AveForwardGameTheory_H
#define AveForwardGameTheory_H
 ...
 */
class AveForwardGameTheory : public BaseWaveApplLayer {
	public:
		...
		AveForwardGameTheory();
        virtual ~AveForwardGameTheory();
	protected:
