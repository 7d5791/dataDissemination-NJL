...
#ifndef BandwidthForwardGameTheory_H
#define BandwidthForwardGameTheory_H
 ...
 */
class BandwidthForwardGameTheory : public BaseWaveApplLayer {
	public:
		...
		BandwidthForwardGameTheory();
        virtual ~BandwidthForwardGameTheory();
	protected:
